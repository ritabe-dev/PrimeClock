...
from .branches import branch_decomposition
...
def convergence_row(
    ...
    *,
    ...
    branches = branch_decomposition(n, max_k=max_branch_k)
    branch_errors = [abs(branch.mass - branch.limit_mass) for branch in branches]
