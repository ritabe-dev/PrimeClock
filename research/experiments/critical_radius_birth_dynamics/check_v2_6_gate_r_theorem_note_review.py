...
REQUIRED_PHRASES = (
    "Gate R local-only",
    "Current readiness is about 80-85%",
    "remaining work is about 0.5-1 slice",
    "Residual Component Boundary Lemma",
    "promote_candidate_after_tightening",
    "Forbidden Special Remainder Lemma",
    "Central Endpoint Obstruction Lemma",
    "Single-Gap Grid Containment Lemma",
    "promote_candidate_as_fixed_gap_geometry",
    "G subset I_q(a)",
    "qR - 1/2 < a < qL + 1/2",
    ...
    "capacity as a general separator",
    "defer",
    "reject",
