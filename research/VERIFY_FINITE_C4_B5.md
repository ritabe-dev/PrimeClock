...
This file is the verifier contract for the narrow `C_k/C_4/B_5` release
bundle. It documents what the included checkers read, what they check, and
what their passing result supports.
